...
from app.core.auth import create_token, ROLES, pwd_context, set_auth_cookie, clear_auth_cookie
...
async def login(req: LoginRequest, response: Response):
    ...
    if req.role == "photographer":
        ...
        if redis_client:
            ...
            if stored_pw:
                expected_pw = stored_pw if isinstance(stored_pw, str) else stored_pw.decode()
